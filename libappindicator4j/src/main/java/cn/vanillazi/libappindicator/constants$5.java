...
final class constants$5 {
    ...
    static final MethodHandle app_indicator_get_icon$MH = RuntimeHelper.downcallHandle(
        ...
        constants$5.app_indicator_get_icon$FUNC
    );
    ...
    static final MethodHandle app_indicator_get_icon_theme_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$5.app_indicator_get_icon_theme_path$FUNC
    );
    ...
    static final MethodHandle app_indicator_get_attention_icon$MH = RuntimeHelper.downcallHandle(
        ...
        constants$5.app_indicator_get_attention_icon$FUNC
    );
    ...
    static final MethodHandle app_indicator_get_attention_icon_desc$MH = RuntimeHelper.downcallHandle(
        ...
        constants$5.app_indicator_get_attention_icon_desc$FUNC
    );
    ...
    static final MethodHandle app_indicator_get_title$MH = RuntimeHelper.downcallHandle(
        ...
        constants$5.app_indicator_get_title$FUNC
    );
}
